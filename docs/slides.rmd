...
```{r, echo = FALSE, code = readLines(file.path(root, "sim/sim_get_data.r"))}
```
...
```{r, echo = FALSE, code = readLines(file.path(root, "sim/sim_perform_EQP.r"))}
```
...
```{r, echo = FALSE, code = readLines(file.path(root, "sim/sim_perform_CP.r"))}
```
...
```{r, echo = FALSE, code = readLines(file.path(root, "sim/sim_results.r")), fig.width = 7, fig.align = "center", dev.args = list(bg = "transparent")}
```
